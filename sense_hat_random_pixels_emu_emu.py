...
Execution:
1. Set the executable flag on the script: chmod u+x sense_hat_random_pixels_emu_emu.py
2. Execute with a preceding dot "./", so call ./sense_hat_random_pixels_emu_emu.py
"""
